...
//
// Usage:
// This is a feat that can be toggled on or off, when the Toggle activity's midi property "Toggle effect" is checked, when unchecked, a dialog to activate the feature
